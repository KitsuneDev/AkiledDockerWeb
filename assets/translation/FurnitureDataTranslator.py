...
orig_product_dict = {}
# Load the JSON file
with open('www/swfs/nitro/gamedata/ProductData.json', 'r', encoding='utf-8') as f:
...
with open('www/swfs/nitro/gamedata/FurnitureData.json', 'w') as f:
    json.dump(orig_furniture_data, f, separators=(',', ':'))

with open('www/swfs/nitro/gamedata/ProductData.json', 'w') as f:
