    ...
    [4], {
        ...
        565: function(t, e, n) {
                            ...
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        ...
                                        return t.abrupt("return");
                                    case 2: /*WSMARK*/
                                        ge.instance.packetManager.addEventHandler(I, this.onClientPing.bind(this)), this._server = new WebSocket("ws"+(window.location.protocol == "https:" ? "s" :"")+"://"+window.location.host+"/gamews"), this._server.binaryType = "arraybuffer", this._server.onmessage = this.onMessage.bind(this), this._server.onopen = function(t) {
            ...
            var ue, le = function(t) {
                ...
                fe = function() {
                    function t(e, n, r, c) {
                        Object(o.a)(this, t), this._id = e, this._name = n, this._instance = new Audio(window.location.origin + "/swfs/sounds/" + n + ".mp3"), this._instance.setAttribute("allow", "autoplay"), this._loop = c, this._volume = 1, this._type = r
                    }
                    return Object(c.a)(t, [{
                        key: "name",
                        get: function() {
            ...
            var tn = function(t, e, n, desc) {
                ...
                rn = Object(Ie.a)(nn, (function() {
                    ...
                    return n("div", {
                        ...
                        attrs: {
                            src: window.location.origin + "/adminpan/pin",
                            width: "730",
                            height: "580",
                            frameborder: "0"
                        }
            ...
            var vn = function(t, e, n, desc) {
                ...
                yn = (n(608), Object(Ie.a)(dn, (function() {
                    ...
                    return n("transition", {
                        ...
                        attrs: {
                            src: window.location.origin + "/alertas/" + t.image + ".gif"
                        }
                    }) : t._e(), t._v(" "), n("div", {
                ...
                Vn = (n(612), Object(Ie.a)($n, (function() {
                    ...
                    return n("transition", {
                        ...
                        return n("tr", {
                            ...
                            staticClass: "item",
                            attrs: {
                                src: window.location.origin + "/items/" + e.name + ".png"
                            }
            ...
            var _r = function(t, e, n, desc) {
                ...
                Or = (n(614), Object(Ie.a)(gr, (function() {
                    ...
                    return n("transition", {
                        ...
                        staticClass: "item",
                        attrs: {
                            src: window.location.origin + "/items/" + t.itemChoice.name + ".png"
                        }
            ...
            var R = function(t, e, n, desc) {
                ...
                k = function(t) {
                    ...
                    return Object(o.a)(l, [{
                        key: "mounted",
                        value: function() {
                            var t = "1" == m.a.get("radio"); //RADIO_URL
                            this._instance = new Audio("https://stream.zenolive.com/1hvvcuhdztzuv.aac"), this._instance.setAttribute("allow", "autoplay"), this._instance.volume = t ? .90 : 0, this._instance.autoplay = !0, this.isPlaying = t
                        }
                    }, {
                        key: "beforeDestroy",
                        value: function() {
