...
<body>
                ...
                <div class="card">
                    <div class="card-body" >
                        ...
                        if (isset($_POST['cloner'])) {
                            $getArticles = $dbh->prepare("SELECT username,ip_last FROM users WHERE username = '" . $_POST['user'] . "' ");
                            $getArticles->execute();
                                ...
                                <div class="table-responsive " style=" max-height: 300px; overflow-y: scroll">
                                    <table class="table table-striped">
                                            ...
                                            <?php echo $news['name']; ?><br>
                                                <tbody>
                                                    <?php
                                                    $Getusers = $dbh->prepare("SELECT * FROM users WHERE ip_last = '" . $news['ip_last'] . "'");
                                                    $Getusers->execute();
    ...
    <td>	<img class="circle"  src="<?php echo $getUsersDev['look']; ?><?php echo $getUsersDev['look']; ?>&direction=3&head_direction=3&gesture=none&action=none&size=n&headonly=1"></td>
