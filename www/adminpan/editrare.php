    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-8 grid-margin stretch-card" style="max-width: 1000px;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Muebles Raros</h4>
                        <p class="card-description"> Elija un mueble a continuación para editar
                        </p>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td> <img class="circle" style="width: 15px; height: 30px;" src="/swfs/dcr/hof_furni/icons/<?= $stringCorrigida; ?>_icon.png"></td>
                                                <td> <span class="title"><?php echo $getUsersDev['catalog_name']; ?> </span></td>
                                                <td>
                                                    <p><?php echo $getUsersDev['cost_diamonds']; ?>
                                                    </p>
                                                <td>
                                                <td><a type="button" class="btn btn-primary" href="<?= $config['hotelUrl']; ?>/adminpan/editfurni/<?php echo $getUsersDev['id']; ?>">Editar</a>
                                                <td>
