                            ...
                            <div class="table-responsive ">
                                <table class="table table-hover">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p> <b class="text-info">ID del RolePlayItem: </b><?php echo admin::EditRolePlayItems("id"); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p><b class="text-warning">Precio:</b> <?php echo admin::EditRolePlayItems("price"); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p><b class="text-danger">Tipo:</b> <?php echo admin::EditRolePlayItems("type"); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p><b class="text-success">Categoría:</b> <?php echo admin::EditRolePlayItems("category"); ?></p>
                                            </td>
                                        </tr>
                                        <br />
                                ...
                                <center>
                                    <font color=red>Descripción:</font><br>
                                    <?php echo admin::EditRolePlayItems("desc"); ?><br><br>
                                    ¡La descripción solo se puede cambiar directamente en la base de datos!
                                </center>
