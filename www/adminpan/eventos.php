                                    ...
                                    ?>
                                            ...
                                            <div class="form-group">
                                                <center>
                                                    ...
                                                    <img style="border-radius: 6px;width: 305px;"
                                                        href="javascript:linkrotate(document.mygallery.topstory.selectedIndex)"
                                                        name="topstory" border=0>
                                            ...
                                            <button name="posteventos" type="submit" class="btn btn-primary mr-2">Crear
                                                evento</button>
                                        </div>
                        </section>
                    </div>
