                        ...
                        <div class="card-body">
                            ...
                            <header class="panel-heading">
                                <form class="forms-sample" name="mygallery" action="" method="POST">
                                    ...
                                    <input id="icon_prefix" type="hidden"
                                        value="<?php echo admin::EditUser("username"); ?>" name="naam"
                                        class="form-control">
                                    <div class="form-group">
                                        <label for="exampleInputName1"><?= $lang["HkUserSearchName"]?></label>
                                        <div class="input-group">
                                            <input <input type="text" value="" name="user" class="form-control"
		...
		?>
				...
				?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="exampleInputName1"><?= $lang["HkEditUser"] ?>
                                            <?php echo admin::EditUserb("username"); ?></label>
                                        <div class="input-input-group-append ">

                                            <input type="hidden" value="<?php echo admin::EditUserb("username"); ?>"
                                                name="naam" class="form-control" disable>
                                        </div>
                                    </div>
                                    <br><br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button name="updatepassword" type="submit"
                                                    class="btn btn-sm btn-info "><?= $lang["HkUserButton"] ?></button>
                                </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-lg-6 grid-margin stretch-card">
			...
			?>
                                <tr>
                                    <td><img
                                            src="<?php echo $config['lookUrl']; ?><?php echo $sqlGetUserr['look']; ?>&direction=3&head_direction=3&gesture=none&action=none&size=n&headonly=1">
                                    </td>
                                    <td><span class="text-primary"><?php echo $sqlGetLogss['username']; ?></span></td>
                                    <td>
                                        <p>Acción: <?php echo $sqlGetLogss['actions']; ?><br>
                                    </td>
                                    <td> <?php echo GetLast($sqlGetLogss['fech']); ?></p>
                                    </td>
                                </tr>
