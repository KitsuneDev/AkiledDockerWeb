                                    ...
                                    <table class="table  table-condensed" id="tableprueba" style="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="color:#6c7293; background:#191c24">
                                                ...
                                                <td><img
                                                        src="<?php echo $config["pathswf"]; ?>/c_images/album1584/<?php echo $pages["badge_code"]; ?>.gif" />
                                                    (<?php echo $pages["badge_code"]; ?>)</td>
                                                <td><?php echo $pages["name"]; ?></td>
                                                <td>
                                                    <center><a type="button" class="btn btn-info"
                                                            href="<?php echo $config['hotelUrl']; ?>/adminpan/editpermissions/<?php echo $pages["id"]; ?>">Editar
                                                    </center></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
