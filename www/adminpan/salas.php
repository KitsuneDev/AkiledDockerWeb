                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr style="color:#6c7293; background:#191c24">
                                                        ...
                                                        <center>
                                                            <td style="color:#6c7293; background:#191c24"><a type="button" class="btn btn-danger" href=' <?php echo  $config['hotelUrl']; ?>/adminpan/salas/delete/<?php echo $news["id"]; ?>'>Eliminar</a></td>
                                                        </center>
                                                    </tr>
                                                <?php } ?>
