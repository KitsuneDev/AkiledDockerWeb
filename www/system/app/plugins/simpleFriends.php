	...
	function friendList()
	{
		...
		if($infoRelationsNum == '0'){
			...
			if($infoRelationsNum == '1'){
				$infoNumtext = $lang["Mfriendsmorecat"];
				}else{
				$infoRelationsNum = $infoRelationsNum - 1;
				$infoNumtext = $lang["Mfriendsyouhavetext1"] . " <b>" . $infoRelationsNum . "</b> " . $lang["Mfriendsyouhavetext2"];
			}
			echo '
			<div class="friend_1"">
			<table>
			...
			<div class="friend_head" style="background: url(https://retroripper.com/habbo-imaging/avatarimage?figure='. filter($infoFriends['look']) .'&head_direction=2&action=wav&headonly=1)">
			</div>
			</div>
			</td>
			<td>
