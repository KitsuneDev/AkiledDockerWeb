<?php
	...
	*/
	...
	$lang["avatarsettings"] = "My clothes";
	...
	$lang['info2'] = "Two factor authentication is an extra security that you can activate with your account. This way you keep hackers even better off your account. To activate 2FA (Two factor authentication) you must have a <b> smartphone </b> and have the <b> Google authenticate app </b>. <br> <br> No <b> Google authenticate app </b> on your phone? Download the app below on your phone!<br><br>";
	$lang['status2'] = "At this moment your 2FA is standing";
	$lang['on2'] = "On";
	$lang['off2'] = "Off";
	$lang['turnon2'] = "You also want to activate 2FA on your account.";
	$lang['click2'] = "Click here";
	$lang['step2'] = "Step";
	$lang['scanapp2'] = "Scan the following QR code with the app";
	$lang['code2'] = "Enter verification code";
	$lang['validate2'] = "Confirm";
	$lang['succes2'] = "Successful";
	$lang['txt12'] = "Two factor authentication is active! The next time you log in you must verify with your 6 digit code.";
	$lang['txt22'] = "Unfortunately, it has not yet succeeded. <a href='".$config['hotelUrl']."/settings2fa/1'> Click here to start from step 1. </a>";
	$lang['loginTitle2'] = "Enter your 6 digit code that you received via the Google Authenticator App below.";
	$lang['loginVlue2'] = "6 digit Two Factor Authentication code";
	$lang['login2'] = "Login";
	$lang['back2'] = "Back";
	$lang['errorCode2'] = "Please Scan above QR code to configure your application and enter genereated authentication code to validated!";
	$lang['errorScanCode2'] = "The code is not correct! Try again.";
	$lang['invalidCode'] = "Invalid Authentication Code!";
	
		// No flash
	$lang['ninfoflash'] = "It is possible that there is no flash installed on your computer, phone or tablet. Unfortunately, you do need this to play ".$config['hotelName']."! Fortunately, there is a solution for this.";
	$lang['ninfoflashtray'] = "Try the steps below:";
	$lang['ninfoflashpc'] = "Are you on your laptop or PC?";
	$lang['nfree'] = "Free";
	$lang['nenableflash'] = "Enable Flash Player on your browser";
	$lang['nenableflashsee'] = "See Enable Flash Player for";
	$lang['nenableflashinfo'] = "for information;";
	$lang['ntitlechrome'] = "Allow Flash in Chrome!";
	$lang['ntitleedge'] = "Allow Flash in Edge!";
	$lang['ntxtchrome'] = "It is possible that Flash Player is not allowed on your Google Chrome. Unfortunately, you do need this to play ".$config['hotelName']."!, there is a solution for this. <br/> <br/> Click &quot;Enable Flash&quot; to play ".$config['hotelName']."! <br/> <br/>";
	$lang['ntxtedge'] = "It is possible that Flash Player is not allowed on your Edge Browser. Unfortunately, you do need this to play ".$config['hotelName']."!, there is a solution for this. <br/> <br/> Click &quot;Enable Flash&quot; to play ".$config['hotelName']."! <br/> <br/>";
	$lang['nbutton'] = "Allow";
	$lang['nbuttonerror'] = "Did not succeed?";
	$lang['ntxtchromeerror'] = "You will now be notified by Google Chrome at the top left of your browser. <br/> <br/> <b> Press &quot;allow&quot; to activate flash and play ".$config['hotelName']."! </b><br/><br/>";
	$lang['ntxtedgeerror'] = "You will now receive a notification from Edge in the upper right corner of your browser. <br/> <br/> <b> Press &quot;Always allow&quot; to activate flash and play ".$config['hotelName']."! </b> <br/> <br/>";
