 ...
 */ !(function (a, b) {
  ...
  function deepExtend(a, b) {
    for (var c in b)
      b[c] && b[c].constructor && b[c].constructor === Object
        ? ((a[c] = $.extend({}, a[c]) || {}), deepExtend(a[c], b[c]))
        : (a[c] = b[c]);
    return a;
  }
  function Spin() {
  ...
  var Browser = (function (a) {
    ...
    Position = {
      ...
      getOrientation: function (a) {
        return a.toLowerCase().match(this.regex.horizontal)
          ? "horizontal"
          : "vertical";
      },
      getSide: function (a) {
      ...
      flip: function (a, b) {
        var c = this.split(a);
        return b
          ? this.inverseCornerPlane(this.flip(this.inverseCornerPlane(a)))
          : this._flip[c[1]] + c[2];
      },
      ...
      isPointWithinBoxLayout: function (a, b, c) {
        return this.isPointWithinBox(
          ...
          c.position.left,
          c.position.top,
          c.position.left + c.dimensions.width,
          c.position.top + c.dimensions.height
        );
      },
      getDistance: function (a, b, c, d) {
        return Math.sqrt(
          Math.pow(Math.abs(c - a), 2) + Math.pow(Math.abs(d - b), 2)
        );
      },
      intersectsLine: (function () {
        ...
        return function (b, c, d, e, f, g, h, i, j) {
          ...
          var o, p;
          if (
            ((o = (-l * (b - f) + k * (c - g)) / (-m * l + k * n)),
            (p = (m * (c - g) - n * (b - f)) / (-m * l + k * n)),
            o >= 0 && 1 >= o && p >= 0 && 1 >= p)
          ) {
            var q = b + p * k,
              r = c + p * l;
    ...
    Bounds = {
      viewport: function () {
        var a;
        return (a =
          Browser.MobileSafari || (Browser.Android && Browser.Gecko)
    ...
    Mouse = {
      ...
      getPosition: function (a) {
        ...
        return {
          left:
            b.left - Math.round(0.5 * this._dimensions.width) + this._shift.x,
          top:
            b.top - Math.round(0.5 * this._dimensions.height) + this._shift.y,
        };
      },
    ...
    Color = (function () {
      ...
      return {
        toRGB: function (a) {
          ...
          var d = a.replace("#", "");
          return (
            /^(?:[0-9a-fA-F]{3}){1,2}$/.test(d) || c._default,
            3 == d.length &&
              (d =
                d.charAt(0) +
                d.charAt(0) +
        ...
        for (var c = this.options.lines, d = 0; c > d; d++) {
          ...
          this._rotate.append(
            (e = $("<div>")
              ...
              .append((f = $("<div>").addClass("tpd-spin-line"))))
          ),
            f.css({
      ...
      return {
        get: function (b) {
          for (var c = null, d = 0; d < a.length; d++)
            a[d] &&
              a[d].url == b.url &&
              (a[d].type || "GET").toUpperCase() ==
                (b.type || "GET").toUpperCase() &&
              $.param(a[d].data || {}) == $.param(b.data || {}) &&
              (c = a[d]);
          return c;
        },
        set: function (b, c, d) {
          var e = this.get(b);
          e || ((e = $.extend({ callbacks: {} }, b)), a.push(e)),
            (e.callbacks[c] = d);
        },
        remove: function (b) {
          for (var c = 0; c < a.length; c++)
            a[c] && a[c].url == b && delete a[c];
        },
        clear: function () {
          a = [];
        },
      ...
      function b(c, d, e) {
        ...
        var f = a.type(arguments[1]),
          ...
          h =
            "function" === f
              ? arguments[1]
              : "function" === a.type(arguments[2])
              ? arguments[2]
              : !1;
        return (
          (this.options = a.extend({ method: "onload" }, g)),
      ...
      a.extend(b.prototype, {
        _add: function (b) {
          var d =
            "string" == a.type(b)
              ? a(b)
              : b instanceof jQuery || b.length > 0
              ? b
              : [b];
          a.each(
            d,
  ...
  var Options = {
    create: (function () {
      function a(b) {
        return (
          (e = Tipped.Skins.base),
          (f = deepExtend($.extend({}, e), Tipped.Skins.reset)),
          (a = d),
          d(b)
        );
      }
      function b(a) {
        return (
          a.match(/^(top|left|bottom|right)$/) && (a += "middle"),
      ...
      function c(a) {
        var b, c;
        return (b =
          a.behavior && (c = Tipped.Behaviors[a.behavior])
            ? deepExtend($.extend({}, c), a)
            : a);
      }
      function d(a) {
        ...
        var j,
          k = (k =
            (i.position && i.position.target) ||
            ("string" == $.type(i.position) && i.position) ||
            (f.position && f.position.target) ||
            ("string" == $.type(f.position) && f.position) ||
            (e.position && e.position.target) ||
            e.position);
        k = b(k);
        var l =
          (i.position && i.position.tooltip) ||
          (f.position && f.position.tooltip) ||
          (e.position && e.position.tooltip) ||
          Tooltips.Position.getInversedPosition(k);
        if (
          ((l = b(l)),
          i.position
            ? "string" == $.type(i.position)
              ? ((i.position = b(i.position)),
                (j = {
                  target: i.position,
              ...
              : ((j = { tooltip: l, target: k }),
                i.position.tooltip && (j.tooltip = b(i.position.tooltip)),
                i.position.target && (j.target = b(i.position.target)))
            : (j = { tooltip: l, target: k }),
          Position.isCorner(j.target) &&
            Position.getOrientation(j.target) !=
              Position.getOrientation(j.tooltip) &&
            (j.target = Position.inverseCornerPlane(j.target)),
          "mouse" == i.target)
        ) {
          var m = Position.getOrientation(j.target);
          j.target =
            "horizontal" == m
              ? j.target.replace(/(left|right)/, "middle")
              : j.target.replace(/(top|bottom)/, "middle");
        }
        i.position = j;
        var n;
        if (
          ("mouse" == i.target
            ? ((n = $.extend({}, e.offset)),
              $.extend(n, Tipped.Skins.reset.offset || {}),
              (n = Position.adjustOffsetBasedOnPosition(
                e.offset,
                e.position,
                j.target,
                !0
              )),
              a.offset && (n = $.extend(n, a.offset || {})))
            : (n = { x: i.offset.x, y: i.offset.y }),
          (i.offset = n),
          i.hideOn &&
            "click-outside" == i.hideOn &&
            ((i.hideOnClickOutside = !0), (i.hideOn = !1), (i.fadeOut = 0)),
          i.showOn)
        ) {
          var o = i.showOn;
        ...
        return (
          i.inline && "string" != $.type(i.inline) && (i.inline = !1),
          Browser.IE &&
            Browser.IE < 9 &&
            $.extend(i, { fadeIn: 0, fadeOut: 0, hideDelay: 0 }),
          i.spinner &&
            (Spin.supported
              ? "boolean" == $.type(i.spinner) &&
                (i.spinner = f.spinner || e.spinner || {})
              : (i.spinner = !1)),
          i.container || (i.container = document.body),
          i.containment &&
            "string" == $.type(i.containment) &&
            (i.containment = {
              selector: i.containment,
              padding:
                (f.containment && f.containment.padding) ||
                (e.padding && e.containment.padding),
            }),
  ...
  $.extend(Skin.prototype, {
    initialize: function (a) {
      ...
      this.tooltip._tooltip[(b.shadow ? "remove" : "add") + "Class"](
        "tpd-no-shadow"
      )
        [(b.radius ? "remove" : "add") + "Class"]("tpd-no-radius")
        [(b.stem ? "remove" : "add") + "Class"]("tpd-no-stem");
      var c,
        d,
        e,
        f,
        g = Support.css.prefixed("borderTopLeftRadius");
      this.element
        .append(
          (c = $("<div>")
            .addClass("tpd-frames")
                  ...
                  $("<div>")
                    ...
                    .append(
                      (d = $("<div>")
                        ...
                        .append(
                          (e = $("<div>").addClass("tpd-background-content"))
                        ))
                    )
                )
            ))
        )
        .append((f = $("<div>").addClass("tpd-spinner"))),
        d.css({ width: 999, height: 999, zoom: 1 }),
        (this._css = {
          ...
          spinner: {
            dimensions: { width: f.innerWidth(), height: f.innerHeight() },
          },
        }),
        f.remove(),
        c.remove(),
    ...
    _getFrame: function (a) {
      ...
      b
        ...
        .css({ "border-top-left-radius": c, "border-top-right-radius": c }),
        b
      ...
      var d = { backgroundColor: this._css.borderColor },
      ...
      if (
        ...
        if (this.tooltip.options.stem)
          if (
            (e
              .find(".tpd-shift-stem")
              .css($.extend({}, d.shift.dimensions, d.shift.position)),
            "vertical" == g)
          ) {
            var h = e.find(
              ".tpd-background-box-top, .tpd-background-box-bottom"
            );
            h.css({ height: this._vars.cut, width: this._css.border }),
              e
                .find(".tpd-background-box-bottom")
                .css({ top: d.dimensions.height - this._vars.cut })
            ...
            var i =
              "right" == c
                ? d.dimensions.width - d.stemPx - this._css.border
                : 0;
            h
              .css({ left: i })
              .find(".tpd-background-box-shift")
              .css({ "margin-left": -1 * i }),
              e
                .find(".tpd-background-box-" + ("left" == c ? "left" : "right"))
                .hide(),
              "right" == c
                ? e
            ...
            h.css({ width: this._vars.cut, height: this._css.border }),
              e
                .find(".tpd-background-box-right")
                .css({ left: d.dimensions.width - this._vars.cut })
                .find(".tpd-background-box-shift")
                .css({
            ...
            var i =
              "bottom" == c
                ? d.dimensions.height - d.stemPx - this._css.border
                : 0;
            h
              .css({ top: i })
              .find(".tpd-background-box-shift")
              .css({ "margin-top": -1 * i }),
              e
                .find(".tpd-background-box-" + ("top" == c ? "top" : "bottom"))
                .hide(),
              "bottom" == c
                ? e
        ...
        this._spinner.css({
          top:
            l.top +
            this._css.border +
            (0.5 * m.height - 0.5 * this._css.spinner.dimensions.height),
          left:
            l.left +
            this._css.border +
            (0.5 * m.width - 0.5 * this._css.spinner.dimensions.width),
        });
      }
    },
    getVars: function () {
      var a = (this._css.padding, this._css.radius, this._css.border),
        ...
        d = { frames: {}, dimensions: c, maxStemHeight: b };
      ...
      return (
        this.tooltip.options.stem &&
          ((e = this.stem_top.getMath().dimensions.outside),
          (f = this.stem_top._css.offset),
          (g = Math.max(e.height - this._css.border, 0))),
        (d.stemDimensions = e),
        (d.stemOffset = f),
        ...
        $.each(
          ...
          $.proxy(function (b, f) {
            var h = Position.getOrientation(f),
              i = "vertical" == h,
              j = { width: c.width + 2 * a, height: c.height + 2 * a },
    ...
    setDimensions: function (a) {
      ...
      (b && b.width == a.width && b.height == a.height) ||
        ((this._dimensions = a), (this._vars = this.getVars()));
    },
    setSide: function (a) {
    ...
    getConnectionLayout: function (a, b) {
      var c = Position.getSide(a),
        ...
        h = this.tooltip.options.stem
          ? f.getMath().dimensions.outside.width
          : 0,
        i = e + g + 0.5 * h,
        j = { stem: {} },
        k = { left: 0, right: 0, up: 0, down: 0 },
        l = { top: 0, left: 0 },
        m = { top: 0, left: 0 },
        n = b.frames[c],
        i = 0;
      if ("horizontal" == d) {
        ...
        this.tooltip.options.stem &&
          ((o = n.shift.dimensions.width),
          2 * g > o - h && (g = Math.floor(0.5 * (o - h)) || 0),
          (i = e + g + 0.5 * h));
        var p = o - 2 * g,
          q = Position.split(a),
          r = g;
        switch (q[2]) {
          case "left":
            ...
            break;
          case "middle":
            (r += Math.round(0.5 * p - 0.5 * h)),
              (k.left = r - g),
              (k.right = r - g),
              (l.left = m.left = Math.round(0.5 * n.dimensions.width));
            break;
          case "right":
            (r += p - h),
              (k.left = p - h),
        ...
        "bottom" == q[1] &&
          ((l.top += n.dimensions.height), (m.top += n.dimensions.height)),
          $.extend(j.stem, {
            position: { left: r },
            before: { width: r },
        ...
        this.tooltip.options.stem &&
          ((s = n.shift.dimensions.height),
          2 * g > s - h && (g = Math.floor(0.5 * (s - h)) || 0),
          (i = e + g + 0.5 * h));
        var t = s - 2 * g,
          q = Position.split(a),
          u = g;
        switch (q[2]) {
          case "top":
            ...
            break;
          case "middle":
            (u += Math.round(0.5 * t - 0.5 * h)),
              (k.up = u - g),
              (k.down = u - g),
              (l.top = m.top = Math.round(0.5 * n.dimensions.height));
            break;
          case "bottom":
            (u += t - h),
              (k.up = t - h),
        ...
        "right" == q[1] &&
          ((l.left += n.dimensions.width), (m.left += n.dimensions.width)),
          $.extend(j.stem, {
            position: { top: u },
            before: { height: u },
    ...
    setStemShift: function (a, b) {
      ...
      if (
        ...
        c.shift.y != b.y ||
        !d ||
        c.dimensions.width != d.width ||
        c.dimensions.height != d.height
      ) {
        this._shift = { stemPosition: a, shift: b, dimensions: d };
        var e = Position.getSide(a),
          f = { horizontal: "x", vertical: "y" }[Position.getOrientation(a)],
          g = {
        ...
        b &&
          0 !== b[f] &&
          ((i.before[g.width] += b[f]),
          (i.position[g.left] += b[f]),
          (i.after[g.left] += b[f]),
          (i.after[g.width] -= b[f])),
    ...
    $.extend(Stem.prototype, {
      ...
      build: function () {
        ...
        var a = this._css.backgroundColor,
          b =
            a.indexOf("rgba") > -1 && parseFloat(a.replace(/^.*,(.+)\)/, "$1")),
          c = b && 1 > b;
      ...
      buildTransform: function () {
        ...
        if (
          ...
          var e = {};
          "top" == d
            ? ((e.bottom = 0), (e.top = "auto"))
            : "left" == d && ((e.right = 0), (e.left = "auto")),
        ...
        var f = Support.css.prefixed("transform"),
          g = {
            ...
            "border-left-width": 0.5 * b.inside.width * c,
        ...
        (alpha =
          h.indexOf("rgba") > -1 && parseFloat(h.replace(/^.*,(.+)\)/, "$1"))),
          alpha && 1 > alpha
        ...
        if (
          ((j[f] =
            ...
            a.border * c +
            "px, " +
            (b.inside.height - this._css.border) * c +
            "px)"),
          this.element.find(".tpd-stem-border-corner").css(j),
      ...
      buildNoTransform: function () {
        ...
        if (
          ...
          var g = {};
          "top" == f
            ? ((g.bottom = 0), (g.top = "auto"))
            : "left" == f && ((g.right = 0), (g.left = "auto")),
        ...
        if ((0.5 * b.inside.width - a.border + "px solid transparent", c)) {
          ...
          if (
            ($.extend(i, l),
            (i[e ? "right" : "left"] = 0),
            (i[e ? "border-left" : "border-right"] =
              b.inside.height + "px solid " + this._css.borderColor),
            $.extend(k, l),
            (k[e ? "border-left" : "border-right"] =
              b.inside.height + "px solid " + this._css.backgroundColor),
            (k[e ? "right" : "left"] = a.top),
            (k[e ? "left" : "right"] = "auto"),
            Browser.IE && Browser.IE < 8)
          ) {
            var m = 0.5 * this._css.width + "px solid transparent";
            $.extend(k, {
              "margin-top": -0.5 * this._css.width,
              "border-top": m,
              "border-bottom": m,
            }),
              (k[e ? "border-left" : "border-right"] =
                this._css.height + "px solid " + this._css.backgroundColor);
          }
          this.element
            .find(".tpd-stem-border-center-offset")
            .css({ "margin-left": -1 * this._css.border * (e ? -1 : 1) })
            .find(".tpd-stem-border-center-offset-inverse")
            .css({ "margin-left": this._css.border * (e ? -1 : 1) });
        } else {
          var l = {
            "margin-left": -0.5 * b.inside.width,
            "border-left": j,
            "border-right": j,
          };
          if (
            ($.extend(i, l),
            (i[d ? "border-top" : "border-bottom"] =
              b.inside.height + "px solid " + this._css.borderColor),
            $.extend(k, l),
            (k[d ? "border-top" : "border-bottom"] =
              b.inside.height + "px solid " + this._css.backgroundColor),
            ...
            var m = 0.5 * this._css.width + "px solid transparent";
            $.extend(k, {
              "margin-left": -0.5 * this._css.width,
              "border-left": m,
              "border-right": m,
            }),
              (k[d ? "border-top" : "border-bottom"] =
          ...
          this.element
            .find(".tpd-stem-border-center-offset")
            .css({ "margin-top": -1 * this._css.border * (d ? -1 : 1) })
            .find(".tpd-stem-border-center-offset-inverse")
            .css({ "margin-top": this._css.border * (d ? -1 : 1) });
        }
      ...
      setPosition: function (a) {
        (this._position = a),
          this.transform.attr(
            "class",
            "tpd-stem-transform tpd-stem-transform-" + a
          );
      },
      getMath: function () {
        ...
        this._useTransform &&
          Math.floor(b) % 2 &&
          (b = Math.max(Math.floor(b) - 1, 0));
        var d = degrees(Math.atan((0.5 * b) / a)),
          e = 90 - d,
          f = c / Math.cos(((90 - e) * Math.PI) / 180),
          g = c / Math.cos(((90 - d) * Math.PI) / 180),
          h = { width: b + 2 * f, height: a + g };
        Math.max(c, this._css.radius), (a = h.height), (b = 0.5 * h.width);
  ...
  var Tooltips = {
    ...
    _getTooltips: function (a, b) {
      ...
      if (
        (_.isElement(a)
          ? (c = $(a).data("tipped-uids")) && (d = d.concat(c))
          : $(a).each(function (a, b) {
              (c = $(b).data("tipped-uids")) && (d = d.concat(c));
            }),
        !d[0] && !b)
      ) {
        var f = this.getTooltipByTooltipElement(
          $(a).closest(".tpd-tooltip")[0]
        );
        f &&
          f.element &&
          ((c = $(f.element).data("tipped-uids") || []),
          c && (d = d.concat(c)));
      }
      return (
        d.length > 0 &&
    ...
    get: function (a) {
      var b = $.extend({ api: !1 }, arguments[1] || {}),
        c = [];
      return (
        _.isElement(a)
          ? (c = this._getTooltips(a))
          : a instanceof $
          ? a.each(
              $.proxy(function (a, b) {
          ...
          : "string" == $.type(a) &&
            $.each(this.tooltips, function (b, d) {
    ...
    getNests: function () {
      var a = [];
      return (
        $.each(this.tooltips, function (b, c) {
          c.is("nest") && a.push(c);
        }),
        a
      );
    ...
    isVisibleByElement: function (a) {
      ...
      return (
        _.isElement(a) &&
          $.each(this.getVisible() || [], function (c, d) {
      ...
      $.each(
        ...
        $.proxy(function (a, b) {
          b.options.ajax &&
            (b._cache &&
              b._cache.xhr &&
              (b._cache.xhr.abort(), (b._cache.xhr = null)),
            b.is("updated", !1),
            b.is("updating", !1),
            b.is("sanitized", !1));
        }, this)
    ...
    removeDetached: function () {
      ...
      a.length > 0 &&
        ...
        $.each(
          ...
          $.proxy(function (a, b) {
            b.element &&
              !_.element.isAttached(b.element) &&
              this.remove(b.element);
          }, this)
        ),
        $.each(b, function (a, b) {
          b.detach();
  ...
  return (
    (Tooltips.Position = {
      ...
      getInversedPosition: function (a) {
        ...
        return (
          "horizontal" == e
            ? (f.vertical && (c = this.inversedPosition[c]),
              f.horizontal && (d = this.inversedPosition[d]))
            : (f.vertical && (d = this.inversedPosition[d]),
              f.horizontal && (c = this.inversedPosition[c])),
          c + d
        );
      },
    ...
    $.extend(Tooltip.prototype, {
      ...
      remove: function () {
        ...
        if (
          (b > -1 && (a.splice(b, 1), $(this.element).data("tipped-uids", a)),
          a.length < 1)
        ) {
          var c,
            d = "tipped-restore-title";
          (c = $(this.element).data(d)) &&
            ("" != !$(this.element)[0].getAttribute("title") &&
              $(this.element).attr("title", c),
            $(this.element).removeData(d)),
          ...
          Browser.IE &&
            ...
            this._tooltip.append(
              (this.iframeShim = $("<iframe>")
                ...
                .attr({ frameBorder: 0, src: "javascript:'';" }))
            ),
          this._tooltip
            ...
            $.each(
              ...
              $.proxy(function (a, b) {
                ...
                if (c && b) {
                  ...
                  Support.touch &&
                  Browser.MobileSafari &&
                  /^(target|element)/.test(a) &&
                  /mouse(leave|out)/.test(d)
                    ? this.bind(c, d, function (a) {
                        if (
                          this._tooltipTouchEndTime &&
                          /^mouse(leave|out)$/.test(a.type)
                        ) {
            ...
            this.bind(
              ...
              $.proxy(function (a) {
                if (this.visible()) {
                  ...
                  (!b || (b && b != this._tooltip[0] && b != this.element)) &&
                    this.hide();
                }
              }, this)
            )),
              ...
              $.proxy(function (a) {
                (this._onResizeDimensions = { width: 0, height: 0 }),
                  this.update(
                    $.proxy(function (b) {
                      return b
                        ? (this.is("visible", !1), this.detach(), void 0)
                        : (a(), void 0);
                    }, this)
                  );
              }, this)
    ...
    $.extend(Tooltip.prototype, {
      ...
      restoreElementToMarker: function () {
        ...
        this.content,
          this.elementMarker &&
            this.content &&
            ((a = $(this.content).data("tpd-restore-inline-display")) &&
              $(this.content).css({ display: a }),
      ...
      _update: function (a, b) {
        ...
        (this.content = a),
          ...
          this._close[
            (this.title || this.options.title) && e ? "show" : "hide"
          ]();
        ...
        this._inner_close[f ? "show" : "hide"](),
          this._tooltip[(g ? "add" : "remove") + "Class"](
            "tpd-has-inner-close"
          ),
      ...
      sanitize: function (a) {
        return !this.options.voila || this._content.find("img").length < 1
          ? (this.is("sanitized", !0), a && a(), void 0)
      ...
      _hasAllImagesSanitized: function () {
        var a = !0;
        return (
          this._content.find("img").each(function (b, c) {
      ...
      refresh: function () {
        if (this.visible()) {
          if (!this.is("sanitized"))
            return this.is("refreshed-before-sanitized", !0), void 0;
      ...
      finishUpdate: function (a) {
        if (
          ...
          b && this._contentWrapper.css({ visibility: "visible" }),
            this.options.afterUpdate(this._content[0], this.element),
            b && this._contentWrapper.css({ visibility: "hidden" });
        }
        a && a();
      },
    }),
    $.extend(Tooltip.prototype, {
      ...
      updateDimensionsToContent: function (a, b) {
        ...
        if (
          ...
          var i = { top: g, right: g, bottom: g, left: g },
            j = 0;
          if ("vertical" == Position.getOrientation(b)) {
            this.options.stem &&
              (i[e] =
                this.skin["stem_" + e].getMath().dimensions.outside.height);
            var k = this.getMouseRoom();
            k[Position._flip[e]] && (i[e] += k[Position._flip[e]]);
            var l = this.getContainmentLayout(b),
              m = this.getPaddingLine(a),
              n = !1;
            Position.isPointWithinBoxLayout(m.x1, m.y1, l) ||
            Position.isPointWithinBoxLayout(m.x2, m.y2, l)
              ? (n = !0)
              : $.each(
                  "top right bottom left".split(" "),
                  $.proxy(function (a, b) {
                    var c = this.getSideLine(l, b);
                    return Position.intersectsLine(
                      m.x1,
                      m.y1,
                      m.x2,
                      m.y2,
              ...
              n &&
                ((j =
                  "left" == e
                    ? m.x1 - l.position.left
                    : l.position.left + l.dimensions.width - m.x1),
                (i[e] += j));
          }
          if (this.options.offset && "vertical" == f) {
            var o = Position.adjustOffsetBasedOnPosition(
              this.options.offset,
          ...
          this.options.containment &&
            (j = this.options.containment.padding) &&
            ($.each(i, function (a) {
              i[a] += j;
            }),
            "vertical" == f
              ? (i["left" == e ? "left" : "right"] -= j)
              : (i["top" == e ? "top" : "bottom"] -= j));
          var p = Bounds.viewport(),
            q = this.close && "overlap" != this.close && !this.title,
            r = { width: 0, height: 0 };
          q &&
            ((r = this._innerCloseDimensions || {
              width: this._inner_close.outerWidth(!0),
              height: this._inner_close.outerHeight(!0),
            }),
            (this._innerCloseDimensions = r)),
            this._contentRelativePadder.css({ "padding-right": r.width }),
            this._contentSpacer.css({ width: p.width - i.left - i.right });
          var s = {
          ...
          if (this.title) {
            ...
            this._titleWrapper
              ...
              this.close &&
                ...
                this._close.hide()),
              this._maxWidthPass &&
                s.width > this.options.maxWidth &&
                this._titleRelative.css({ width: s.width }),
              this._titleRelativePadder.css({ "padding-right": u.width });
            var v = parseFloat(this._titleWrapper.css("border-bottom-width"));
            (t = {
              width: this.title ? this._titleWrapper.innerWidth() : 0,
              height: Math.max(
                this.title ? this._titleWrapper.innerHeight() + v : 0,
                u.height + v
              ),
            }),
              t.width > p.width - i.left - i.right &&
                ((t.width = p.width - i.left - i.right),
                this._titleSpacer.css({ width: t.width }),
                (t.height = Math.max(
                  this.title ? this._titleWrapper.innerHeight() + v : 0,
                  u.height + v
                ))),
          ...
          if (
            (this._contentSpacer.css({ width: s.width }),
            s.height !=
              Math.max(this._content.innerHeight(), r.height) +
                (this.title ? this._titleRelative.outerHeight() : 0) &&
              s.width++,
            this.is("resize-to-content") ||
              (s = this.skin._css.spinner.dimensions),
            this.setDimensions(s),
            (i = { top: g, right: g, bottom: g, left: g }),
            this.options.stem)
          ) {
          ...
          this.options.maxWidth &&
            ...
            this.updateDimensionsToContent(a, b),
      ...
      getContainmentSpace: function (a, b) {
        ...
        return (
          e.top > g.top + h.height && (i.top -= e.top - (g.top + h.height)),
          e.top + f.height < g.top && (i.bottom -= g.top - (e.top + f.height)),
          e.left > g.left + h.width &&
            g.left + h.width >= e.left &&
            (i.left -= e.left - (g.left + h.width)),
          ...
          if (this.options.containment) {
            ...
            if (
              ...
              if (
                ((d = j),
                (c = Position.flip(b)),
                i[Position.getSide(d)]
                  ? (this.updateDimensionsToContent(d, c),
                    (f = this.getPositionBasedOnTarget(d, c)))
                  : (f.contained = !1),
                f.contained)
              )
                ...
                var k,
                  ...
                  n =
                    "horizontal" == Position.getOrientation(l)
                      ? ["left", "right"]
                      : ["top", "bottom"];
                k =
                  m[n[0]] === m[n[1]]
                  ...
                  if (
                    ($.each(g, function (a, b) {
                      if (b.position.top >= 0 && b.position.left >= 0) r = b;
                        ...
                        var c =
                            b.position.top >= 0 ? 1 : Math.abs(b.position.top),
                          d =
                            b.position.left >= 0
                              ? 1
                              : Math.abs(b.position.left);
      ...
      getPositionBasedOnTarget: function (a, b) {
        ...
        if (
          ((m.top = l.top + l.connection.top),
          (m.left = l.left + l.connection.left),
          (m.top -= m.connection.top),
          (m.left -= m.connection.left),
          this.options.stem)
        ) {
          ...
          if (
            ...
            if (t >= n) {
              var u = { top: 0, left: 0 },
                v = r[s] < o.stem[s] ? -1 : 1;
              (u[s] = q * v),
                (u[s] += Math.floor(0.5 * n) * v),
                (m.left += u.left),
                (m.top += u.top);
            } else {
              $.extend(o, {
                center: {
                  top: Math.round(l.top + 0.5 * c.height),
                  left: Math.round(l.left + 0.5 * c.left),
                },
              });
              var w = {
                  connection: Position.getDistance(
        ...
        var z = this.getContainment({ top: m.top, left: m.left }, b),
          ...
          if (0 !== H) {
            ...
            if (L >= H * M && m[G] + H >= J)
              ...
              if (((m[G] += L * M), (B[F] = -1 * L * M), m[G] < J)) {
                ...
                m[G] += N;
                var P = B[F] - N;
                P >= f.connections[b].move[E[0]] &&
                  P <= f.connections[b].move[E[1]] &&
                  (B[F] -= N);
              }
              ...
              var Q = z.correction[F],
                R = deepExtend({}, m);
              this.options.offset &&
                ((R.left -= this.options.offset.x),
                (R.top -= this.options.offset.y));
              var o = {
                stem: {
              ...
              if ("x" == F) {
                ...
                Q > 0 && (V += S.dimensions.width - 2 * T),
                  ((0 > Q && o.stem.left + Q >= V && R.left + Q >= J) ||
                    (Q > 0 && o.stem.left + Q <= V && R.left + Q <= U)) &&
                    (R.left += Q);
              } else {
                var W = S.position.top + T;
                Q > 0 && (W += S.dimensions.height - 2 * T),
                  ((0 > Q && o.stem.top + Q >= W && R.top + Q >= J) ||
                    (Q > 0 && o.stem.top + Q <= W && R.top + Q <= U)) &&
                    (R.top += Q);
              }
              (m = R),
                this.options.offset &&
                  ((m.left += this.options.offset.x),
                  (m.top += this.options.offset.y));
            }
          }
          (z = this.getContainment({ top: m.top, left: m.left }, b)),
            (A = z.horizontal && z.vertical);
      ...
      setPosition: function (a, b) {
        ...
        if (!c || c.top != a.top || c.left != a.left) {
          ...
          if (this.options.container != document.body) {
            ...
            if (d[0]) {
              var f = $(d).offset(),
                g = { top: Math.round(f.top), left: Math.round(f.left) },
                h = {
      ...
      isSideWithinContainment: function (a, b, c) {
        ...
        if (
          Position.isPointWithinBoxLayout(f.x1, f.y1, d) ||
          Position.isPointWithinBoxLayout(f.x2, f.y2, d)
        )
          return !0;
        var g = !1;
        return (
      ...
      getContainment: function (a, b) {
        ...
        if (this.options.containment) {
          ...
          this.options.containment &&
            ((a.left < d.position.left ||
              a.left + e.width > d.position.left + d.dimensions.width) &&
              ((c.horizontal = !1),
              (c.correction.x =
                a.left < d.position.left
                  ? d.position.left - a.left
                  : d.position.left + d.dimensions.width - (a.left + e.width))),
            (a.top < d.position.top ||
              a.top + e.height > d.position.top + d.dimensions.height) &&
              ((c.vertical = !1),
              (c.correction.y =
                a.top < d.position.top
                  ? d.position.top - a.top
                  : d.position.top +
                    d.dimensions.height -
                    (a.top + e.height))));
        }
      ...
      getContainmentLayout: function (a, b) {
        var c = { top: $(window).scrollTop(), left: $(window).scrollLeft() },
          d = this.target;
        "mouse" == d && (d = this.element);
        var e,
          f = $(d).closest(this.options.containment.selector).first()[0];
        e =
          f && "viewport" != this.options.containment.selector
            ? {
                dimensions: {
                  width: $(f).innerWidth(),
        ...
        if (g && !b) {
          ...
          if ((2 * g > h && (g = Math.max(Math.floor(0.5 * h), 0)), g)) {
            ...
            "vertical" == i
              ? ((e.dimensions.width += g),
                "left" == Position.getSide(a) && (e.position.left -= g))
              : ((e.dimensions.height += g),
                "top" == Position.getSide(a) && (e.position.top -= g));
          }
        }
      ...
      getPaddingLine: function (a) {
        var b = this.getTargetLayout(),
          c = "left";
        if ("vertical" == Position.getOrientation(a))
          return this.getSideLine(b, Position.getSide(a));
        if (Position.isCorner(a)) {
          var d = Position.inverseCornerPlane(a);
          return (c = Position.getSide(d)), this.getSideLine(b, c);
        }
        var e = this.getSideLine(b, c),
          f = Math.round(0.5 * b.dimensions.width);
    ...
    $.extend(Tooltip.prototype, {
      bind: function (a, b, c, d) {
        ...
        this._cache.events.push({ element: a, eventName: b, handler: e }),
          $(a).bind(b, e);
      },
      unbind: function () {
    ...
    $.extend(Tooltip.prototype, {
      is: function (a, b) {
        return (
          "boolean" == $.type(b) && (this._cache.is[a] = b), this._cache.is[a]
        );
      },
      visible: function () {
    ...
    $.extend(Tooltip.prototype, {
      ...
      clearTimer: function (a) {
        this._cache.timers[a] &&
          (clearTimeout(this._cache.timers[a]), delete this._cache.timers[a]);
      },
    ...
    $.extend(Collection.prototype, {
      ...
      refresh: function () {
        return (
          $.each(this._tooltips, function (a, b) {
