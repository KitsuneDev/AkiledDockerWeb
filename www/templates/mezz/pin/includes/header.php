<head>
    	...
    	<link rel="stylesheet" href="<?= $config['hotelUrl'];?>/templates/mezz/pin/views/css/materialize.min.css">
		<link rel="stylesheet" href="<?= $config['hotelUrl'];?>/templates/mezz/pin/views/css/styles.css">
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css">
		<link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
		<script src="<?= $config['hotelUrl'];?>/templates/mezz/pin/views/js/alertify.min.js"></script>
		<link rel="stylesheet" href="<?= $config['hotelUrl'];?>/templates/mezz/pin/views/css/alertify.min.css"/>
