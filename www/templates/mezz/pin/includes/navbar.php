...
<nav class="navb grey lighten-5 black-text">
    <div class="nav-wrapper">
      ...
      <a href="<?php echo $config['hotelUrl']; ?>/adminpan/dash"><img class="circle" style="height: 62px;width: 62px;background-color:#4272d7;border:2px solid #FFF;" src="<?php echo $config['look']; ?><?php echo User::userData('look'); ?>&direction=3&head_direction=3&gesture=none&action=none&size=n&headonly=1"></a>
