...
<div id="map-locator">
  <div class="container clearfix">
	...
	<?php User::editUsername(); ?>
	  ...
	  <p>
<input action="post" align="left" method="post" id="PINbox" type="text" name="username" style="padding: 15px;border-color: #fff;width: 100%;background: rgb(243, 243, 243);border: 0px;color: #828282;border-radius: 5px;" placeholder="Nombre de tu usuario">
      <p><p>
	  </p>
      <button type="submit" name="editusername">Guardar cambios</button><br><br>
    </div>
	</form>
  </div>
</div>
