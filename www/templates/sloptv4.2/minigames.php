  ...
  <section class="contenido">
    <section class="cortos">
      ...
      <div class="section">
        <article style="margin-bottom: 6px">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT37JQPfC2Q1M1qtMp1aDRD1vuxYats9M-tjg&usqp=CAU"
            alt=""
          />
          <div class="desc-article">
            <a onclick="cargarCortos(4)">
              <span style="color: red; font-size: 14px"
                ><b style="color: white">Jugar: </b>FastFood</span
              >
            </a>
          </div>
        </article>
        <article>
          <img
            src="http://www.geeknews.it/wp-content/uploads/2014/04/pacman.gif"
            alt=""
          />
          <div class="desc-article">
            <a onclick="cargarCortos1(2)">
              <span style="color: red; font-size: 14px"
                ><b style="color: white">Jugar: </b>Pacman</span
              >
            </a>
          </div>
        </article>
    ...
    <section class="cortos">
      ...
      <div class="section">
	    <article>
          <img
            src="https://i.imgur.com/JPwXKHW.gif"
            alt=""
          />
          <div class="desc-article">
            <a onclick="cargarCortos2(3)">
              <span style="color: red; font-size: 14px"
                ><b style="color: white">Jugar: </b>Among us</span>
            </a>
          </div>
        </article></div>
    </section>
